...
static uint8_t AppData[] = { 0xde, 0xad, 0xbe, 0xef};
static uint8_t AppDataSize = sizeof(AppData);
 ...
 */
static void OnTxNextPacketTimerEvent( void * ctx )
{
...
//                LoRaMacCallbacks.GetBatteryLevel = BoardGetBatteryLevel;
		...
		TxNextPacketTimer.id = TxNextPacketTimer_app;
                TIMER_INIT( TxNextPacketTimer, OnTxNextPacketTimerEvent );
