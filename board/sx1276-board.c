...
#define NRF_LOG_MODULE_NAME "SX1276"
...
void SX1276IoInit( void )
{
	...
	NRF_LOG_DEBUG("IoInit done\r\n");
}

void SX1276IoIrqInit( DioIrqHandler **irqHandlers )
{
	NRF_LOG_DEBUG("IoIrqInit\r\n");
	...
	NRF_LOG_DEBUG("IoIrqInit done\r\n");
}

void SX1276IoDeInit( void )
{
	NRF_LOG_DEBUG("IoDeInit\r\n");
...
void SX1276SetAntSwLowPower( bool status )
{
    if( RadioIsActive != status )
    {
        ...
        {
            SX1276AntSwInit( );
	    SX1276Write( REG_LR_DIOMAPPING1, (RFLR_DIOMAPPING1_DIO0_01 | RFLR_DIOMAPPING1_DIO1_00 | RFLR_DIOMAPPING1_DIO2_00 | RFLR_DIOMAPPING1_DIO3_00));
	    SX1276Write( REG_LR_DIOMAPPING2,RFLR_DIOMAPPING2_DIO4_00);
        }
        else
        {
            SX1276AntSwDeInit( );
            SX1276Write( REG_LR_DIOMAPPING1, RFLR_DIOMAPPING1_DIO0_00 | RFLR_DIOMAPPING1_DIO1_00 | RFLR_DIOMAPPING1_DIO2_00 | RFLR_DIOMAPPING1_DIO3_00);
...
void SX1276SetAntSw( uint8_t opMode )
{
    ...
    case RFLR_OPMODE_TRANSMITTER:
        ...
        SX1276Write( REG_LR_DIOMAPPING1, (RFLR_DIOMAPPING1_DIO0_01 | RFLR_DIOMAPPING1_DIO1_00 | RFLR_DIOMAPPING1_DIO2_00 | RFLR_DIOMAPPING1_DIO3_00));
        SX1276Write( REG_LR_DIOMAPPING2,RFLR_DIOMAPPING2_DIO4_00);
	//SX1276Write(REG_LR_TCXO,0x09); // external crystal
	...
	//SX1276Write( REG_LR_OPMODE, 0x83 );
...
//        SX1276Write( REG_LR_OPMODE, RFLR_OPMODE_SLEEP );
        //SX1276Write( REG_LR_DIOMAPPING2, 0x40 );
